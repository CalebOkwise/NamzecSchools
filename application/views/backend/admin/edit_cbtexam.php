...
$exam_id = isset($exam['id']) ? $exam['id'] : '';
$selected_class_id = isset($exam['class_id']) ? $exam['class_id'] : '';
$selected_subject_id = isset($exam['subject_id']) ? $exam['subject_id'] : '';
$start_datetime = !empty($exam['start_at']) ? date('Y-m-d\TH:i', strtotime($exam['start_at'])) : '';
$end_datetime = !empty($exam['end_at']) ? date('Y-m-d\TH:i', strtotime($exam['end_at'])) : '';
    ...
    <div class="col-sm-8 col-sm-offset-2">
        <div class="panel panel-info">
            <div class="panel-heading">
                <i class="fa fa-plus"></i>&nbsp;&nbsp;<?php echo 'Update CBT Exam';?>
            </div>
            <div class="panel-wrapper collapse in" aria-expanded="true">
                <div class="panel-body">
                    <form method="POST" action="<?php echo base_url(); ?>admin/cbt/update_exam/<?php echo $exam_id; ?>" class="form-horizontal form-groups-bordered validate">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" 
                                               ...
                                               value="<?php echo html_escape($exam['title']); ?>" 
                                               required>
                                        ...
                                        <select class="form-control select2" 
                                            ...
                                            <?php if (!empty($classes)): ?>
                                                <?php foreach ($classes as $class): ?>
                                                    <option value="<?php echo $class['class_id']; ?>" <?php if ($selected_class_id == $class['class_id']) echo 'selected'; ?>><?php echo html_escape($class['name']); ?></option>
                                                <?php endforeach; ?>
                                            <?php endif; ?>
                                        </select>
                                    </div>
                                        ...
                                        <select class="form-control select2" 
                                            ...
                                            <?php if (!empty($subjects)): ?>
                                                <?php foreach ($subjects as $subject): ?>
                                                    <option value="<?php echo $subject['subject_id']; ?>" <?php if ($selected_subject_id == $subject['subject_id']) echo 'selected'; ?>><?php echo html_escape($subject['name']); ?></option>
                                                <?php endforeach; ?>
                                            <?php endif; ?>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-group">
                                            <input type="number" 
                                                   ...
                                                   name="duration" 
                                                   placeholder="60" 
                                                   value="<?php echo html_escape($exam['duration_minutes']); ?>" 
                                                   min="5" 
                                                   max="480" 
                                                   required>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <textarea class="form-control" 
                                                  ...
                                                  name="instructions" 
                                                  rows="5" 
                                                  placeholder="<?php echo get_phrase('Enter exam instructions for students');?>"><?php echo html_escape($exam['instructions']); ?></textarea>
                        ...
                        <div class="form-group m-t-20">
                            ...
                            <button type="submit" 
                                ...
                                <button type="submit" 
                                        ...
                                        name="action" 
                                        value="continue">
                                    <i class="fa fa-arrow-right"></i>&nbsp;<?php echo get_phrase('Save Adjustments');?>
                                </button>
