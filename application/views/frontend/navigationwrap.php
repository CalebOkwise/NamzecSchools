<!--Navigation Wrap Start-->
        <div class="logo_nav_outer_wrap">
        	<div class="container">
                <div class="logo_wrap">
                    <a href="#"><img src="<?php echo base_url();?>uploads/logo.png" width="45px" height="45px" alt="School Logo"></a>
                </div>
                
               
                <nav class="main_navigation">
                    <ul>
                        <li><a href="<?php echo base_url()?>website">Home<span>MAIN PAGE</span></a></li>
                ...
                <div id="kode-responsive-navigation" class="dl-menuwrapper">
                    ...
                    <ul class="dl-menu">
                        <li class="active"><a href="index.html">Home</a></li>
						 <li class="menu-item kode-parent-menu"><a href="<?php echo base_url()?>website/about">About Us</a></li>
